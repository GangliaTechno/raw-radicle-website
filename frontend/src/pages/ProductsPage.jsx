  ...
  return (
    <main className="rr-collection-redesign" id="main" role="main">
      <style>{`
        ...
        .rr-collection-redesign .ProductQuickViewOverlay{position:fixed;inset:0;z-index:400;background:rgba(0,0,0,.45);backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px);display:flex;align-items:center;justify-content:center;padding:28px;animation:rrQuickBackdrop .22s ease both}
        .rr-collection-redesign .ProductQuickView{position:relative;width:min(800px,calc(100vw - 56px));min-height:350px;background:#fff;border-radius:20px;overflow:hidden;box-shadow:0 28px 76px rgba(0,0,0,.18);text-align:left;opacity:0;visibility:hidden;pointer-events:none;transform:translateY(22px) scale(.965);transition:opacity .28s cubic-bezier(.22,1,.36,1),visibility .28s ease,transform .28s cubic-bezier(.22,1,.36,1)}
        ...
        .rr-collection-redesign .ProductQuickView__Close{position:absolute;top:16px;right:16px;z-index:10;width:34px;height:34px;border:none;border-radius:50%;background:rgba(255,255,255,.85);color:#111;font-size:16px;font-weight:600;line-height:34px;text-align:center;box-shadow:0 2px 8px rgba(0,0,0,.12);cursor:pointer;transition:background .2s,transform .2s;display:flex;align-items:center;justify-content:center}
        .rr-collection-redesign .ProductQuickView__Close:hover{background:#111;color:#fff;transform:scale(1.05)}
        .rr-collection-redesign .ProductQuickView__Media{background:#f6f6f6;border-right:1px solid #e7e7e7;display:flex;align-items:center;justify-content:center;padding:0;position:relative}
        .rr-collection-redesign .ProductQuickView__Gallery{position:relative;width:100%;height:100%;overflow:hidden;user-select:none}
        .rr-collection-redesign .ProductQuickView__GalleryTrack{display:flex;width:100%;height:100%;transition:transform 0.35s cubic-bezier(0.25, 0.46, 0.45, 0.94);will-change:transform}
        .rr-collection-redesign .ProductQuickView__GallerySlide{flex:0 0 100%;width:100%;height:100%;display:flex;align-items:center;justify-content:center}
        .rr-collection-redesign .ProductQuickView__GallerySlide img{width:100%;height:100%;max-height:270px;object-fit:contain;display:block}
        .rr-collection-redesign .ProductQuickView__GalleryArrow{position:absolute;top:50%;transform:translateY(-50%);width:32px;height:32px;border-radius:50%;background:rgba(255,255,255,.8);border:none;font-size:20px;line-height:1;color:#111;display:flex;align-items:center;justify-content:center;cursor:pointer;z-index:5;transition:background .2s,opacity .2s;box-shadow:0 2px 6px rgba(0,0,0,.1)}
        .rr-collection-redesign .ProductQuickView__GalleryArrow:hover{background:#fff}
        .rr-collection-redesign .ProductQuickView__GalleryArrow:disabled{opacity:0;pointer-events:none}
        .rr-collection-redesign .ProductQuickView__GalleryArrow--prev{left:10px}
        .rr-collection-redesign .ProductQuickView__GalleryArrow--next{right:10px}
        .rr-collection-redesign .ProductQuickView__GalleryDots{position:absolute;bottom:12px;left:50%;transform:translateX(-50%);display:flex;gap:6px;z-index:5}
        .rr-collection-redesign .ProductQuickView__GalleryDot{width:8px;height:8px;border-radius:50%;background:rgba(0,0,0,.2);border:1px solid rgba(255,255,255,.6);padding:0;cursor:pointer;transition:background .2s,transform .2s}
        .rr-collection-redesign .ProductQuickView__GalleryDot.is-active{background:#fff;transform:scale(1.25);border-color:rgba(0,0,0,.2)}
        ...
        @media(max-width:1150px){.rr-collection-redesign .ProductList{gap:56px 48px}.rr-collection-redesign .CollectionInner{padding:52px 24px}}
        ...
        @media(max-width:640px){.rr-collection-redesign .PageHeader{padding:42px 16px}.rr-collection-redesign .SectionHeader__Heading{font-size:18px;letter-spacing:.26em}.rr-products-toolbar{height:auto;flex-wrap:wrap}.rr-layout-cell{width:100%;height:50px;border-right:0;border-bottom:1px solid #d2d2d2}.rr-toolbar-controls{width:100%;height:50px}.rr-toolbar-control{width:50%}.rr-toolbar-button{height:50px;min-width:0!important;width:100%;padding:0 12px;font-size:10px;letter-spacing:.18em}.rr-toolbar-popover{top:50px;width:100%}.rr-collection-redesign .ProductList{grid-template-columns:repeat(2,minmax(0,1fr));gap:42px 18px}.rr-collection-redesign .ProductItem__ImageShell{margin-bottom:26px}.rr-collection-redesign .ProductItem__QuickButton{right:10px;bottom:10px;width:38px;height:38px;font-size:23px}.rr-collection-redesign .ProductQuickViewOverlay{align-items:center;padding:16px}.rr-collection-redesign .ProductQuickView{width:100%;min-height:0;max-height:calc(100vh - 32px);border-radius:20px;overflow:auto;transform:translateY(18px) scale(.98)}.rr-collection-redesign .ProductQuickView.is-open{transform:translateY(0) scale(1)}.rr-collection-redesign .ProductQuickView__Inner{grid-template-columns:1fr;min-height:0}.rr-collection-redesign .ProductQuickView__Media{border-right:0;border-bottom:1px solid #e7e7e7;padding:12px;min-height:180px;height:180px}.rr-collection-redesign .ProductQuickView__Media img,.rr-collection-redesign .ProductQuickView__GallerySlide img{max-height:156px}.rr-collection-redesign .ProductQuickView__Content{padding:18px 20px 20px}.rr-collection-redesign .ProductQuickView__Title{font-size:14px;letter-spacing:.1em;margin-bottom:6px}.rr-collection-redesign .ProductQuickView__Price{margin-bottom:12px}.rr-collection-redesign .ProductQuickView__Description{font-size:11px;margin-bottom:12px;line-height:1.5}.rr-collection-redesign .ProductQuickView__Meta{margin-bottom:14px}.rr-collection-redesign .ProductQuickView__Meta div{display:flex;justify-content:space-between;align-items:center;padding:8px 0;border-bottom:1px solid #e6e6e6;grid-template-columns:none;gap:0}.rr-collection-redesign .ProductQuickView__Meta dt{font-size:9px;margin:0}.rr-collection-redesign .ProductQuickView__Meta dd{font-size:11px;margin:0;text-align:right}.rr-collection-redesign .ProductQuickView__Marketplaces{display:flex;gap:8px;margin-bottom:12px;grid-template-columns:none}.rr-collection-redesign .ProductQuickView__Marketplaces a{flex:1;min-height:36px;font-size:9px;letter-spacing:.1em;border-radius:6px}.rr-collection-redesign .ProductQuickView__Link{width:100%;box-sizing:border-box;border-radius:8px;min-height:44px}.rr-collection-redesign .ProductItem__Title{font-size:10px;letter-spacing:.13em}.rr-collection-redesign .ProductItem__PriceList{font-size:9px;letter-spacing:.08em}.rr-collection-redesign .CollectionInner{padding:42px 14px}}
      `}</style>
