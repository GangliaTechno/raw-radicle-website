...
(() => {
  ...
  function M(e, t, s, n) {
    T(n || document, t, function (t) {
      for (var n, i = t.target || t.srcElement; i && !(n = C(i, e)); )
        i = i.parentElement;
      n && s.call(i, t);
    });
  }
  class x {
    constructor(e, t) {
      ...
      (this.autocompleteAttr = e.getAttribute("autocomplete")),
        ...
        T(window, "resize", this.updateSC),
        T(e, "blur", this.blurHandler),
        T(e, "keydown", this.keydownHandler),
        T(e, "keyup", this.keyupHandler),
        this.minChars || T(e, "focus", this.focusHandler);
      const s = this;
      M(
    ...
    unload() {
      _(window, "resize", this.updateSC),
        _(this.input, "blur", this.blurHandler),
        _(this.input, "focus", this.focusHandler),
        _(this.input, "keydown", this.keydownHandler),
        _(this.input, "keyup", this.keyupHandler),
    ...
    save(e) {
      ...
      this.start(),
        ...
        l(
          ...
          S.stringify({ url: t, snapshot: s, tags: n || [] })
        );
    }
    start() {
      this.hide([
  ...
  function E(e, t, s) {
    ...
    function r(e, s) {
      ...
      for (let e of o) {
        ...
        o &&
          !o.startsWith(t) &&
          o.startsWith(i) &&
          (o.startsWith("data:") || a.push(o));
      }
    }
    r("img"),
      r("frame"),
      r("iframe", (e) => "playback" !== e.id),
      r("script"),
      r("link", (e) => "stylesheet" === e.rel, "href");
    ...
    c.length > 0
      ...
      : ((s.innerHTML = "There are no sub-resources in the page."),
  ...
  function R(e) {
    ...
    if (t.length > 0)
      for (var s = 0; s < t.length; s++)
        N(t[s]).classList.remove("wb-highlight");
  }
  function U(e, t) {
    for (
  ...
  var O, D, I;
  function q(e, t, s) {
    ((O = e)._dstate = { root: !1 }), (I = s), (D = t);
    const n = O.querySelector("#wm-capinfo-notice");
    n &&
      ("api" == n.getAttribute("source")
        ? (async function (e, t) {
            const { url: s, timestamp: n } = t,
              ...
              r = [];
            {
              const e = await $(a, { credentials: "omit" }),
                { status: t, notices: s } = await e.json();
            ...
            if (l) {
              const s = (function (e) {
                let t = e.match(
                  /^https?:\/\/(?:twitter|x)\.com\/i\/web\/status\/(\d+)/
                );
                if (t) return t[1];
                if (
                  ((t = e.match(
              ...
              if (s) {
                const t = new URLSearchParams([
                  ...
                  n = `${B}?${t}`,
                  i = await $(n, { credentials: "omit" }),
                  { status: o, notes: a } = await i.json();
                if ("success" == o && a?.length > 0) {
                  const t = (e.getAttribute("birdwatch-browse") || W) + s;
                  r.push(
                    `This post has <a href="${t}">${a.length} community note${
                      a.length > 1 ? "s" : ""
                    }</a>`
                  );
                }
  ...
  function P() {
    ...
    t.root
      ? (O._dstate = { root: !1 })
      : e
      ? (O._dstate = { root: !1, notice: !0 })
      : t.notice
      ? (O._dstate = { root: !1 })
      : ((O._dstate = { root: !0 }), (s = !0));
    const { root: n, notice: i } = O._dstate;
    if (
      (n
        ? ((O.style.display = "block"),
          D.classList.add("wm-open"),
          D.classList.remove("wm-closed"))
        : i
        ? ((O.style.display = "block"),
          O.classList.add("notice-only"),
          D.classList.add("wm-open"),
          D.classList.remove("wm-closed"))
        : ((O.style.display = "none"),
          O.classList.remove("notice-only"),
          D.classList.remove("wm-open"),
          D.classList.add("wm-closed")),
      s)
    ) {
  ...
  function Z(e, t) {
    c(e) || (e = [e]);
    for (var s = 0; s < e.length; s++) Q(e[s], t);
  }
  var ee = /web\/(\d*)\/http:\/\/web\.archive\.org\/screenshot/g;
  ...
  function se() {
    ...
    te("https://wayback-api.archive.org/clog/", {
      method: "POST",
    ...
    ((window.__wm = {
      ...
      wombat: function (e, s, i, o, a, r) {
        const l = `${i}${o}/`,
          ...
          h = i.replace(/^https?:/, ""),
          u = [
            "https://wwwb-events.archive.org/events",
      ...
      bt: function (e, t, s, n, i, o, a, r, c, h, u) {
        ...
        const p = {
            url: o,
            timestamp: (V = a),
            staticPrefix: (K = c || "/static/"),
            playbackPrefix: d,
            replayUrl(e, t) {
              return `${this.playbackPrefix}${e}/${t ?? this.url}`;
            },
          },
          m = f(p.timestamp);
        ...
        var M,
          ...
          N = z("wm-ipp-base");
        if (N.attachShadow) {
          var A = N.attachShadow({ mode: "closed" });
          for (G = A; N.children.length > 0; ) A.appendChild(N.children[0]);
          if (h)
            for (var R = 0; R < h.length; R++) {
              var U = X.createElement("link");
              U.setAttribute("rel", "stylesheet"),
                U.setAttribute("type", "text/css"),
                U.setAttribute("href", h[R]),
                A.appendChild(U);
            }
        }
        function $() {
          const e = z("donato")?.offsetHeight || 0,
            t = z("wm-ipp-inside").offsetHeight - z("wm-capinfo").offsetHeight,
            s = e + t;
          console.debug(
        ...
        (window.top != window.self &&
          "force" != N.getAttribute("toolbar-mode")) ||
          (N.style.display = "block");
        var O = !1,
          D = !0;
        const I = z("donato-if")?.contentWindow;
        var j = z("donato");
        ...
        z("wm-tb-close").addEventListener("click", (e) => {
          (z("wm-ipp-inside").style.display = "none"), e.preventDefault(), $();
        });
        var W = z("wm-ipp-sparkline");
        function Q(e) {
          ...
          if (t !== M) {
            ...
            t
              ...
              (S.style.display = t ? "inline" : "none"),
              (M = t);
          }
        }
        z("wm-expand").addEventListener("click", (e) => {
          e.stopPropagation(), e.preventDefault(), P();
        }),
          (z("wm-graph-anchor")._no_rewrite = !0),
          ((x = X.createElement("div")).className = "yt"),
          (x.style.display = "none"),
          (x.style.width = s + "px"),
          (x.style.height = t + "px"),
          ((S = X.createElement("div")).className = "mt"),
          (S.style.display = "none"),
          (S.style.width = n + "px"),
          (S.style.height = t + "px"),
          W.appendChild(x),
          W.appendChild(S);
        var te = z("wm-sparkline-canvas");
        (W.onmouseenter = Q),
          (W.onmouseleave = Q),
            ...
            var i,
              ...
              h =
                ...
                (void 0 !== i.getBoundingClientRect
                  ...
                  (window.scrollX || a.scrollLeft) -
                  (a.clientLeft || 0)),
              u = Math.min(Math.max(0, c - h), e),
              p = u % s,
              m = Math.floor(u / s),
              f = Math.min(11, Math.floor(p / n)),
              v = 12 * m + f,
              w = p % 2 == 1 ? 15 : 1,
              b = y(m + r) + y(f + 1, 2) + y(w, 2) + "000000";
            (z("displayYearEl").innerHTML = m + r),
              (z("displayMonthEl").innerHTML = g(f));
            var C = d + b + "/" + o;
            if (((z("wm-graph-anchor").href = C), E != m)) {
              var T = m * s;
              (x.style.left = T + "px"), (E = m);
            }
            if (k != v) {
              var _ = m + v * n + 1;
              (S.style.left = _ + "px"), (k = v);
            }
          });
        const se = z("wm-toolbar");
        var ne = z("wm-sparkline-canvas");
        if (ne.getContext && ne.getContext("2d")) {
          var ie =
            "/__wb/sparkline?output=json&url=" +
            encodeURIComponent(o) +
            ((i && "&collection=" + i) || "");
          "async" == se.getAttribute("nav") && (ie += `&nav=${V}`),
            l("GET", ie, function (s) {
              if (200 == s.status) {
                for (
                  var n = F.parse(s.responseText),
                    i = n.years,
                ...
                !(function (e) {
                  ...
                  n.nav &&
                    (function (e, t) {
                      ...
                      function l(t, s, n) {
                        if (null != s) {
                          const i = v(s, "%H:%M:%S %b %d, %Y"),
                            o = e.querySelector(t),
                            a = document.createElement("a");
                          a._orig_setAttribute("href", p.replayUrl(s)),
                            a._orig_setAttribute("title", i),
                            n && (o.textContent = v(s, n));
                          for (let e = o.firstChild; e; e = o.firstChild)
                            a.appendChild(e);
                          o.appendChild(a);
                        }
                      }
          ...
          (oe.src =
            ...
            (oe.border = "0"),
            te.parentNode.replaceChild(oe, te);
        }
        function ae(e) {
          return e
        ...
        (z("wm-share-facebook").onclick = function (e) {
          ...
          (z("wm-share-twitter").onclick = function (e) {
            const t = this.dataset.url;
            return (
              Y(
          ...
          new L(z("wmtbURL"), {
            ...
            source: function (e, t) {
              l(
                ...
                function (s) {
                  if (
                    void 0 !== (s = F.parse(s.response)).hosts &&
                    s.hosts.length > 0
                  ) {
                    var n = ae(s.hosts);
                    t(n);
          ...
          (z("wmtb").onsubmit = function (e) {
            var t = z("wmtbURL").value;
            if (
              0 !== t.indexOf("http://") &&
              0 !== t.indexOf("https://") &&
              ...
              return (
                (document.location.href = "/web/*/" + z("wmtbURL").value),
                e.preventDefault(),
                !1
              );
          }),
          (function (e, t, s) {
            ...
            e
              ? ((z("wm-screenshot").title = "screenshot (delta: " + t + "s)"),
                Z("wm-screenshot", !0))
              : Z("wm-screenshot", !1);
          }),
          u &&
            (function (e, t) {
              !(function (e, t, s) {
                ...
                if (e.status < 300) {
                  ...
                  Z("wm-video", !0),
                    (z("wm-video").href = t.url),
                    (z("wm-video").title = "Video: " + t.title);
                } else Z("wm-video", !1);
              });
            })(o, V),
          q(z("wm-capinfo"), z("wm-expand"), p),
          new H(z("wm-save-snapshot-open"), o, V),
          $();
      },
      ajax: l,
      sp: function () {
